def ethical_explain(header, value=None):
    ...
    explanations = {
        ...
        "Access-Control-Allow-Methods": {
            "description": "Определяет разрешенные HTTP методы для CORS запросов.",
            "ethical_impact": "🎯 Ограничивает возможные действия извне",
            "privacy_risk": "Средний - избыточные методы увеличивают поверхность атаки",
            "user_trust": "Важен для контроля доступа к API",
            "simple_description": "Определяет разрешенные HTTP методы для CORS."
        },
        "Access-Control-Allow-Headers": {
            "description": "Указывает разрешенные заголовки для CORS запросов.",
            "ethical_impact": "📋 Контролирует передаваемые метаданные",
            "privacy_risk": "Средний - лишние заголовки могут раскрыть информацию",
            "user_trust": "Повышает предсказуемость API",
            "simple_description": "Указывает разрешенные заголовки для CORS."
        },
        "Access-Control-Allow-Credentials": {
            "description": "Разрешает передачу учетных данных в CORS запросах.",
            "ethical_impact": "🔐 Управляет доступом к аутентифицированным ресурсам",
            "privacy_risk": "Высокий - неправильная настройка может раскрыть сессии",
            "user_trust": "Критически важен для защищенных сервисов",
            "simple_description": "Разрешает передачу учетных данных в CORS."
        }
    }
